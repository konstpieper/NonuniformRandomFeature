function u = SSN_TR(p, Sred, ref, alpha, phi, u0)
%{ 
%% Solve the problem: 
...
%% vector case (NQ > 1) is not implemented...
NQ = 1
...
while (iter < maxiter)
  ...
  %pause(1);
    ...
    fprintf('SSNTR %d: j = %e, |I| = %d, |g| = %1.3e\n', ...
    ...
    fprintf('\tpcg pred.: %1.3e relres: %1.1e, iter: %3d (%s)\t', pred, relres, iter1(end), flag); 
